...
- 在 TypeScript 中通过 [`customConditions`](https://www.typescriptlang.org/tsconfig/#customConditions) 来配置，可通过 [官方文档](https://www.typescriptlang.org/docs/handbook/modules/reference.html#packagejson-exports) 来了解 TS 对条件导出的处理方式；
