---
title: 移动端开发的优良习惯、技巧与避坑
old_filename: 移动端开发的优良习惯、技巧与避坑
date: 2022-02-13 10:00:00
tags: [DOC, JS, CSS, Scaffold, WebAPI]
categories: [DOC]
---
...
目前，大部分移动端 UI 组件库都提供了身份证号码输入框，或者提供了自定义输入键盘的功能。应用广泛的大厂组件库，可以查看 [PaperPlane Awesome](https://paperplane.cc/awesome) 来进一步查看。
