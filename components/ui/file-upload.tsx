  ...
  return (
    <ArkFileUpload.Dropzone
      className={cn(
        ...
        'text-center',
        'border-input rounded-2xl border-2 border-dashed',
        'cursor-pointer',
...
type FileUploadListProps = Omit<React.ComponentProps<typeof ArkFileUpload.Item>, 'file'>
  ...
  return (
    <ArkFileUpload.ItemPreview
      className={cn(
        ...
        'text-primary text-[0.5rem] font-semibold',
        'bg-primary/10',
        'select-none',
        'rounded-full',
        className
...
export const FileUploadItemName = (props: React.ComponentProps<typeof ArkFileUpload.ItemName>) => {
  ...
  return (
    <ArkFileUpload.ItemName
      className={cn('truncate text-xs font-medium', 'min-w-0', 'overflow-hidden', className)}
