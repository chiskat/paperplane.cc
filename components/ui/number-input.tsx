  ...
  return (
    <ArkNumberInput.Control
      className={cn(
        ...
        'aria-invalid:border-destructive aria-invalid:ring-destructive/24 aria-invalid:ring-[3px]',
...
export const NumberInputDecrement = (
  ...
  return (
    <ArkNumberInput.DecrementTrigger
      ...
      className={cn(
        'relative',
        'h-[calc(--spacing(8)-2px)] in-data-[size=lg]:h-[calc(--spacing(9)-2px)] in-data-[size=sm]:h-[calc(--spacing(7)-2px)]',
        'flex shrink-0',
        'text-foreground',
