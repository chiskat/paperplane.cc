    ...
    >
      <ArkRadioGroup.ItemControl
        className={cn(
          ...
          'size-4',
          'border-input border shadow-xs/5',
          'bg-input/30',
          'rounded-full',
          'before:size-1.5 before:rounded-full',
          'data-focus-visible:border-primary data-focus-visible:ring-ring/32 data-focus-visible:ring-offset-background data-focus-visible:ring-[3px] data-focus-visible:ring-offset-1',
          ...
          'dark:data-invalid:border-destructive-foreground dark:data-invalid:text-destructive dark:data-invalid:ring-destructive-foreground/20 dark:data-invalid:ring-[3px]',
          'data-[state=checked]:bg-primary data-[state=checked]:before:bg-primary-foreground',
          'data-invalid:data-[state=checked]:before:bg-destructive-foreground data-invalid:data-[state=checked]:bg-transparent'
        )}
