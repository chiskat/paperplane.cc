...
import { DatePicker as ArkCalendar, parseDate as arkParseDate } from '@ark-ui/react/date-picker'
...
export const CalendarLabel = (props: React.ComponentProps<typeof ArkCalendar.Label>) => (
  <ArkCalendar.Label className="text-sm font-medium" data-slot="calendar-label" {...props} />
)
...
export const CalendarYearSelect = (props: React.ComponentProps<typeof ArkCalendar.YearSelect>) => {
  ...
  return (
    <div
      className={cn('relative w-fit has-[select:disabled]:opacity-64', className)}
...
export const CalendarWeekDays = (props: CalendarWeekDaysProps) => {
  ...
  return (
    <CalendarContext>
      {calendar => (
        <CalendarTableHead className={cn(className)} data-slot="calendar-table-head" {...rest}>
          <CalendarTableRow>
  ...
  return (
    <ArkCalendar.TableHeader
      className={cn(
        ...
        'text-muted-foreground/64 text-xs font-medium select-none',
        'rounded-lg',
        className
      )}
    ...
    >
      <ArkCalendar.TableCellTrigger
        className={cn(
          ...
          'text-foreground text-base leading-none font-normal whitespace-nowrap select-none sm:text-sm',
          'rounded-md border border-transparent',
          'hover:bg-accent hover:text-accent-foreground',
          'data-today:data-selected:after:bg-background data-today:after:bg-primary data-today:after:absolute data-today:after:bottom-1 data-today:after:left-1/2 data-today:after:size-1 data-today:after:-translate-x-1/2 data-today:after:rounded-full',
          'data-focus:border-primary data-focus:bg-accent/30 data-focus:text-primary data-focus:ring-ring/32 data-focus:ring-[3px]',
          ...
          'data-[view=day]:data-in-range:not-[data-selected]:bg-primary/10 data-[view=day]:data-in-range:rounded-none',
