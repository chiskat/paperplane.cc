    ...
    >
      ...
      <ArkColorPicker.ChannelSliderThumb
        className={cn(
          ...
          'ring-border/64 ring-1 outline-none',
  ...
  return (
    <ArkColorPicker.SwatchTrigger
      className={cn(
        ...
        'focus-visible:border-primary focus-visible:ring-ring/32 focus-visible:ring-offset-background outline-none focus-visible:ring-[3px] focus-visible:ring-offset-2',
