...
export const SelectTrigger = (props: SelectTriggerProps) => {
  const { showClearTrigger = false, size = 'md', className, children, ...rest } = props
    ...
    <ArkSelect.Control data-slot="select-control">
      <ArkSelect.Trigger
        className={cn(
          ...
          'data-[state=open]:border-ring data-[state=open]:ring-ring/32 data-[state=open]:ring-[3px]',
...
export const SelectGroup = (props: SelectGroupProps) => {
  ...
  return (
    <ArkSelect.ItemGroup className={cn(className)} data-slot="select-group" {...rest}>
...
export const SelectGroupLabel = (props: React.ComponentProps<typeof ArkSelect.ItemGroupLabel>) => {
  ...
  return (
    <ArkSelect.ItemGroupLabel
      className={cn('px-2 py-1.5', 'text-muted-foreground text-xs font-semibold', className)}
  ...
  return (
    <ArkSelect.Item
      className={cn(
        ...
        'py-1.5 ps-2 pe-8',
        'flex items-center gap-2',
        'text-base select-none md:text-sm',
        'rounded-md',
        'cursor-default',
        'outline-hidden',
...
export const SelectClearTrigger = (props: React.ComponentProps<typeof ArkSelect.ClearTrigger>) => {
  ...
  return (
    <ArkSelect.ClearTrigger
      ...
      className={cn(
        '[&_svg]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:size-3.5 [&_svg]:shrink-0',
        'transition-opacity',
        'opacity-64',
...
export const SelectEmpty = (props: React.ComponentProps<typeof ark.div>) => {
  ...
  if (empty) {
    return (
      <ark.div
        className={cn('px-2 py-1.5', 'text-muted-foreground text-center text-sm', className)}
        role="presentation"
        {...rest}
      />
    )
